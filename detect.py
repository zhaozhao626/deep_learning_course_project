...
class DetOptions():
    def __init__(self):
        ...
        self.train_gt_dir = './data/train_gts'                 
        self.test_dir = './data/test_imgs'
        self.save_dir = './temp/det_models/'                            # 保存检测模型
        # self.saved_model_path = './drive/MyDrive/temp/det_models/checkpoint_final'    # 保存最终检测模型
        self.saved_model_path = './temp/det_models/checkpoint_64'
        # self.saved_model_path = "./drive/MyDrive/temp/det_models/checkpoint_9-loss-0.6758644580841064"
...
def det_train():
    ...
    for epoch in range(det_args.max_epoch):
        ...
        print("保存阶段模型")
        save_name = 'checkpoint_' + str(epoch) + "-loss-" +str(loss.item())
...
def det_test():
    # 模型加载
    model = SegDetectorModel(device)
    # det_args.saved_model_path = "./drive/MyDrive/temp/det_models/checkpoint_8-loss-0.7099710702896118"
...
if __name__=="__main__":
    ...
    # model.load_state_dict(torch.load("/temp/det_models/checkpoint_64"))
    # model.load_state_dict(torch.load("./drive/MyDrive/temp/det_models/checkpoint_9-loss-0.6758644580841064"))
